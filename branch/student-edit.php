                                    ...
                                    <form id="editStud_form" data-id="<?php echo $result['id']; ?>">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="regi_numr" class="form-control" id="regi_no" placeholder="Registration Number" value="<?php echo 'GTIVE/' . $cursResult['course_code'] . '/' . $rdate . $result['reg_month'] . $result['reg_no'];; ?>">
