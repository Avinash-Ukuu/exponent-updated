...
if ($okk != 0) {
    ...
    echo ("GTIVE/$course[course_code]/$rsdate$month$reg_num") . '###' . $reg_num . '###' . $en_session . $month . $roll_num;
} else {

    $rn = '001';

    echo "GTIVE/$course[course_code]/$rsdate$month$rn" . '###' . $rn . '###' . $en_session . $month . '001';
}
