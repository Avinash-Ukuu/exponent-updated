<?php
    ...
    if (isset($_GET['course_id'])) {
        ...
        $query = "SELECT * FROM tb_course WHERE id = ?";
...
<head>
    ...
    <title><?php echo $course['name']; ?> - Course Details</title>
    ...
    <link rel="stylesheet" href="assets/css/coursesdetail.css">
...
<body data-rsssl="1"
    ...
    <section>
        <div class="container">
            ...
            <div class="bread-crumb_bottom">
                <h2><?php echo $course['name']; ?></h2>
                <img src="./uploads/courses/cookingcourses.jpg" alt="">
            </div>
        </div>
    </section>
    <section class="aboutcourse">
        <div class="container">
            <div>
                <div class="bread-crumb_lastbottom">
                    <h2>About Course</h2>
                    <!-- <p>Bachelors in Hospitality Management Culinary Specialization</p> -->
                ...
                <div>
                    <table style="width:100%">
                        ...
                        <tr>
                            <th>Eligibility</th>
                            <td><?php echo $course['course_eligibility']; ?></td>
