...
<body data-rsssl="1"
    ...
    $blogs = "SELECT * FROM blogs WHERE publish_type = 'published' ORDER BY created_at DESC";
        ...
        <div class="containerCustom">
            ...
            <div class="blog-content blog-switch-layout blog-list">                
                ...
                if ($blogsResult->num_rows > 0) {
                    $imageBasePath = "uploads/blogImages/";
                    while ($row = $blogsResult->fetch_assoc()) {
                ?>
                    <div class="postarticles ">
                        <!-- Display blog image -->
                        <img class="postarticleimg" src="<?php echo $imageBasePath . $row['image']; ?>" alt="Blog Image">

                        <!-- Blog title -->
                        <div>
                            <h2><?php echo $row['title']; ?></h2>

                            <!-- Blog excerpt or description -->
                            <p><?php echo substr($row['description'], 0, 150); ?>...</p>

                            <!-- Link to full blog -->
                            <a href="blogs/<?php echo $row['link']; ?>"><button>Read More</button></a>
                        </div>
                    </div>
                <?php
                    }
