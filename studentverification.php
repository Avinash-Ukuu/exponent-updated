...
<head>
    ...
    <title>Exponent Institute India - Home</title>
        ...
        <div class="contactus" style="margin: 20px 0;padding-top: 50px;">
            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <form action="" method="post" id="verify_stud">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-0">
                                    ...
                                    <select class="form-control customForm" name="setcours_name" id="stud_name">
                                        ...
                                        ?>
                                                ...
                                                <option value="<?php echo $stusql_result['id']; ?>"><?php echo $stusql_result['name']; ?> </option>
                                ...
                                <div class="form-group col-md-6 mb-0">
                                    ...
                                    <input name="setstu_dob" type="date" id="studdob" placeholder="DD-MM-YYYY" required="" class="form-control" />
                                ...
                                <div class="form-group col-md-12 mb-0">
                                    ...
                                    <input name="stu_exam_name" type="text" id="studname" required="" class="form-control" />
                    ...
                    <div class="col-sm-3 col-xs-12 mb-0">
