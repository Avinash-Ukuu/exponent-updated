...
<body data-rsssl="1"
    ...
    $courses = "SELECT * FROM tb_course WHERE status = '1' ORDER BY date DESC";
    $coursesResult = $conn->query($courses);
    ...
    <section class="bread-crumb">
        <div class="container">
            ...
            <?php
                ...
                ?>
                <a class="courescard" href="course-detail.php?course_id=<?php echo $row['id']; ?>">
                    <img src="./uploads/courses/cookingcourses.jpg" alt="course image">
                    <div class="coursesheading">
                        <h2><?php echo $row['name']; ?></h2>
                        <p> <strong><?php echo $row['course_duration']; ?> <i class="fa fa-clock-o"></i> Duration of the Course Cook </strong> </p>
