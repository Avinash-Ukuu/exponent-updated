                                    ...
                                    <form id="blogForm" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-6">
                                                ...
                                                <textarea name="description" style="height: 250px;" class="form-control" required></textarea>
                                            </div>
                                            <div class="form-group col-6">
                                                <label>Meta Description</label>
                                                <textarea name="meta_description" style="height: 250px;" class="form-control" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Content</label>
