...
<head>
    ...
    <title>Galaxy Techno | Department Form</title>
                                ...
                                <form id="addStud_form">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="regi_no"
                                                placeholder="Registration Number" name="regi_numr">
                                        </div>
                                        <div class="form-group">
                                            <label for="stu_name">Student Name</label>
                                            <input type="text" class="form-control" id="stu_name"
                                                placeholder="Student Name" name="stu_name">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="stu_dob"
                                                placeholder="Student DOB" name="stu_dob">
                                        </div>
                                        <!-- Date -->

                                        <div class="form-group">
                                            <label for="stu_rollno">Roll No. </label>
                                            <input type="text" class="form-control" id="stu_rollno"
                                                placeholder="Student Roll Number" name="stu_rollno">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="stu_img"
                                                        name="stu_proimg">
