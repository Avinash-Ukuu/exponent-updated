...
$query = "SELECT * FROM image_gallery ORDER BY created_at DESC";
...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-md-12">
                            <div class="card card-outline card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Image Gallery List</h3>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php $iteration = 1;
                                                ...
                                                <tr id="blog_<?php echo $row['id']; ?>">
                                                    ...
                                                    <td>
                                                        <a href="edit_imageGallery.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                                        <button onclick="deleteImageGallery(<?php echo $row['id']; ?>)" class="btn btn-sm btn-danger">Delete</button>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
    ...
    <script>
        ...
        function deleteImageGallery(imageGalleryId) {
            if (confirm('Are you sure you want to delete this blog?')) {
                $.ajax({
                    url: 'delete_imageGallery.php',
                    type: 'POST',
                    data: {
                        id: imageGalleryId
                    },
